...
export const DataConfidenceLegend: React.FC = () => (
  <Box sx={{ display: 'flex', gap: 1.5, alignItems: 'center', px: 1, py: 0.75, bgcolor: '#FAFAFA', borderRadius: 1, border: '1px solid #E0E0E0', mb: 2, flexWrap: 'wrap' }}>
    ...
    <Chip icon={<WarningAmberIcon sx={{ fontSize: '12px !important', color: '#E65100 !important' }} />} label="Estimated — from CRM / analysis" size="small"
    ...
    <Chip icon={<PowerIcon sx={{ fontSize: '12px !important', color: '#B71C1C !important' }} />} label="EDW / Direct Query — source not yet connected" size="small"
      sx={{ height: 20, fontSize: '0.6rem', bgcolor: '#FFEBEE', color: '#B71C1C', border: '1px dashed #EF9A9A', '& .MuiChip-icon': { ml: '4px' } }} />
  </Box>
);
